...
<div class="container">
    ...
    <c:if test="${not empty accountAlreadyExists}">
        <div class="alert alert-danger" role="alert">
                ${accountAlreadyExists}
        </div>
    </c:if>

    <c:if test="${not empty accountCreateSuccess}">
    ...
    <form:form modelAttribute="user">
        ...
        <table>
            ...
            <tr>
                <td colspan="3">
                    <input type="submit" value="Create account" class="btn btn-primary btn-lg">
                    <a href="login" class="btn btn-secondary btn-lg"> Cancel </a>
                </td>
        </table>
    </form:form>
</div>
