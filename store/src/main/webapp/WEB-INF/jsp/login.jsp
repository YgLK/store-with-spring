...
<div class="container">
    ...
    <c:if test="${not empty incorrectCredentials}">
    ...
    <form:form action="login" method="post">
        ...
        <div><label> Email <br>    <input type="text" class="form-control" name="email"/> </label></div>
        <div><label> Password <br> <input type="password" class="form-control" name="password"/> </label></div>
        <input type="submit" class="btn btn-lg btn-primary" role="button" value="Login"/>
    </form:form>
    <div class="control-group">

        <a href="create-account" class="btn btn-secondary btn-lg">Create new account</a>
    </div>
</div>
</body>
</html>